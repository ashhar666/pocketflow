...
const testimonials = [
  {
    ...
    name: "Alex V.",
    designation: "Regular User | Daily Tracker"
  },
  {
    ...
    name: "Sarah L.",
    designation: "Business Owner | Local Shop"
  },
  {
    ...
    name: "Marcus T.",
    designation: "Daily User | Smart Saver"
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-12">
          ...
          >
            ...
            <span className="text-xs font-black uppercase tracking-[0.4em] italic">User Reviews</span>
          </motion.div>
          ...
          >
            What <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20">Users Say</span>
          </motion.h2>
        </div>
